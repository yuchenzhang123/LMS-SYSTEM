<template>
  ...
  >
    <div class="dialog-content" :class="{ 'edit-mode': isEditMode }">
      ...
      <!-- Current saved values (always shown) -->
      <el-descriptions
      ...
      <template v-if="isEditMode">
        ...
        <el-form :model="form" label-width="110px">
          ...
          <el-form-item label="提交律所时间" v-if="isFieldVisible('submitToLawFirmDate')">
            <el-date-picker v-model="form.submitToLawFirmDate" type="date" value-format="yyyy/M/d" placeholder="请选择提交律所时间" style="width: 100%;"></el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="提交法院时间" v-if="isFieldVisible('submitToCourtDate')">
            <el-date-picker v-model="form.submitToCourtDate" type="date" value-format="yyyy/M/d" placeholder="请选择提交法院时间" style="width: 100%;"></el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="开庭时间" v-if="isFieldVisible('hearingDate')">
            <el-date-picker v-model="form.hearingDate" type="date" value-format="yyyy/M/d" placeholder="请选择开庭时间" style="width: 100%;"></el-date-picker>
          </el-form-item>
          <el-form-item label="判决时间" v-if="isFieldVisible('judgmentDate')">
            <el-date-picker v-model="form.judgmentDate" type="date" value-format="yyyy/M/d" placeholder="请选择判决时间" style="width: 100%;"></el-date-picker>
          </el-form-item>
          <el-form-item label="执行申请提交时间" v-if="isFieldVisible('executionApplyToCourtDate')">
            <el-date-picker v-model="form.executionApplyToCourtDate" type="date" value-format="yyyy/M/d" placeholder="请选择执行申请提交时间" style="width: 100%;"></el-date-picker>
          </el-form-item>
          <el-form-item label="执行立案时间" v-if="isFieldVisible('executionFilingDate')">
            <el-date-picker v-model="form.executionFilingDate" type="date" value-format="yyyy/M/d" placeholder="请选择执行立案时间" style="width: 100%;"></el-date-picker>
          </el-form-item>
          ...
          <el-form-item label="诉讼和保全支付时间" v-if="isFieldVisible('litigationPreservationPaidAt')">
            <el-date-picker v-model="form.litigationPreservationPaidAt" type="date" value-format="yyyy/M/d" placeholder="请选择诉讼和保全支付时间" style="width: 100%;"></el-date-picker>
          </el-form-item>
          <el-form-item label="诉讼和保全销账时间" v-if="isFieldVisible('litigationPreservationWriteOffAt')">
            <el-date-picker v-model="form.litigationPreservationWriteOffAt" type="date" value-format="yyyy/M/d" placeholder="请选择诉讼和保全销账时间" style="width: 100%;"></el-date-picker>
          </el-form-item>
